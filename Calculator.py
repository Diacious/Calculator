...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.b_trunc = QPushButton("trunc", self)
        self.hbox_third.addWidget(self.b_trunc)
        ...
        self.b_trunc.clicked.connect(self._trunc)
    ...
    def _trunc(self):
        num_1 = self.input.text()
        self.input.setText(num_1.replace(num_1[num_1.find('.'):], ''))


    def _result(self):
        if self.num_1 == '':
            return self.input.setText(self.input.text())
